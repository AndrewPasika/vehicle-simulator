...
def get_points_along_path(_from, _to, departure_time=None, period=5):
    """
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print('Usage: python ' + sys.argv[0] + ' "From Address"  "To Address"')
        print('For example')
        print('Usage: python ' + sys.argv[0] + ' "HashedIn Technologies, Bangalore"  "World Trade Centre, Bangalore"')
        exit(-1)

    points = get_points_along_path(sys.argv[1], sys.argv[2])
